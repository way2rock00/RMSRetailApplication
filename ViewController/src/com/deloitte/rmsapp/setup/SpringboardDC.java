...
//        springboardItems.add(new SpringboardItem("Home", "icon-3-financials fa-lg"));
        springboardItems.add(new SpringboardItem("Notification", "fa fa-bell-o fa-0.5x", "com.deloitte.rmsapp.Notification"));
//        springboardItems.add(new SpringboardItem("Settings", "icon-3-financials fa-lg",""));
        springboardItems.add(new SpringboardItem("Logout", "fa fa-sign-out fa-0.5x","Logout"));        
    }
